...
export const mockProducts: Product[] = [
  ...
  { nombre: 'Cartera Trenzada', codigo: 'K038TR', medidas: '31 x 40 cm (Base: 12 cm)', categoriaSlug: 'bolsos-carteras', imagen: bolsoTrenzado, origen: 'Hecho a mano en El Salvador' },
  ...
  { nombre: 'Bolso Bucket', codigo: 'K041CK', medidas: '29 x 32 cm (Base: 22 cm)', categoriaSlug: 'bolsos-carteras', imagen: bolsoBucket, origen: 'Hecho a mano en El Salvador' },
  { nombre: 'Bolso Playero', codigo: 'K035JU', medidas: '40 x 55 cm (Base: 15.5 cm)', categoriaSlug: 'bolsos-carteras', imagen: bolsoPlayero, origen: 'Hecho a mano en El Salvador' },

  // Bandoleras y Morrales (/catalogo/bandoleras-morrales)
  { nombre: 'Bandoleras', codigo: 'K018B', medidas: '22 x 25 cm (Base: 20 x 5 cm)', categoriaSlug: 'bandoleras-morrales', imagen: bandoleraImg, origen: 'Hecho a mano en El Salvador' },
  { nombre: 'Bolso Media Luna', codigo: 'K040LUNA', medidas: '30 x 36 cm (Base: 11 cm, Altura central: 23 cm)', categoriaSlug: 'bandoleras-morrales', imagen: bolsoMedialuna, origen: 'Hecho a mano en El Salvador' },
  { nombre: 'Morrales', codigo: 'K024MR', medidas: '26 x 30 cm (Base: 6 x 24 cm)', categoriaSlug: 'bandoleras-morrales', imagen: morralesImg, origen: 'Hecho a mano en El Salvador' },
  { nombre: 'Bolso Hobo', codigo: 'K027H0B', medidas: '25 x 42 cm (Base: 33 x 10 cm)', categoriaSlug: 'bandoleras-morrales', imagen: bolsoHobo, origen: 'Hecho a mano en El Salvador' },
  { nombre: 'Bandolera Masculina', codigo: 'K042MEN', medidas: '25 x 19.5 cm', categoriaSlug: 'bandoleras-morrales', imagen: bandoleraMasc, origen: 'Hecho a mano en El Salvador' },
  ...
  { nombre: 'Bolso Multiusos', codigo: 'K020BS', medidas: '34 x 39 cm (Base: 5 cm)', categoriaSlug: 'especialidades', imagen: bolsoMultiusos, origen: 'Hecho a mano en El Salvador' },
];
