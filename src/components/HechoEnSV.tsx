  ...
  const valores = [
    {
      ...
      titulo: "Hecho a Mano",
      descripcion: "Cada pieza es elaborada con dedicación artesanal, sin producción en masa.",
    },
    {
      icono: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      titulo: "100% Salvadoreño",
      descripcion: "Orgullosamente elaborado en El Salvador, preservando nuestra identidad cultural.",
    },
    {
      icono: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      titulo: "Materiales Naturales",
      descripcion: "Utilizamos yute, algodón y denim de alta calidad con conciencia ambiental.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-8">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            >
              Lo que nos <span className="italic font-normal text-[#7EC8BD]">define</span>
            </h2>
          </div>
        </ScrollReveal>
