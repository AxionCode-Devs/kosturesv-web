          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-12">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-white/50 text-sm leading-relaxed max-w-xs">
                Confección de accesorios artesanales hechos a mano en El Salvador.
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-3 text-sm">
                ...
                <a href="mailto:c.kosture@gmail.com" className="text-white/50 hover:text-white no-underline transition-colors duration-300 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                  c.kosture@gmail.com
                </a>
              </div>

              {/* Redes Sociales con SVGs reales */}
              <div className="flex gap-3 mt-6">
                <a href="https://www.facebook.com/kosturesv" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/50 hover:border-[#1A9E8F] hover:text-[#1A9E8F] hover:scale-110 no-underline transition-all duration-300">
